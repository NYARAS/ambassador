...
func Setup(app *fiber.App) {
	...
	ambassadorAuthenicated.Post("links", controllers.CreateLink)
	ambassadorAuthenicated.Get("stats", controllers.Stats)
	ambassadorAuthenicated.Get("rankings", controllers.Rankings)
